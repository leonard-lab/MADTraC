...
SegmenterFrame::SegmenterFrame(wxFrame* parent,
                               wxWindowID id,
...
void SegmenterFrame::initUserData()
{
...
void SegmenterFrame::handleCommandLineArguments(int argc, char** argv)
{
    long temp;
...
void SegmenterFrame::initTracker()
{
